...
const apis = [
  ...
  },
  {
    ...
    schema: {
      ...
      attributes: {
        ...
        marketingPoint1: { type: "string", required: false },
        marketingPoint2: { type: "string", required: false },
  ...
  {
    folder: "country-flag",
    uid: "api::country-flag.country-flag",
    singular: "country-flag",
    plural: "country-flags",
    collection: "country_flags",
    kind: "collectionType",
    schema: {
      kind: "collectionType",
