...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'About Us: mission, center, values, facility gallery, virtual tour';
  ...
  attributes: {
    ...
    centerText: Schema.Attribute.Text & Schema.Attribute.Required;
    ...
    facilityGalleryTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Facilities & Gallery'>;
    ...
    virtualTourYoutubeUrl: Schema.Attribute.String;
  };
}
...
export interface ApiBookingPageBookingPage extends Struct.SingleTypeSchema {
  collectionName: 'booking_page';
  info: {
    description: 'Booking page config: time slots and SEO';
...
export interface ApiCountryGuidelineCountryGuideline
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visaCategories: Schema.Attribute.Text & Schema.Attribute.Required;
  };
}
...
export interface ApiEquipmentItemEquipmentItem
  ...
  attributes: {
    ...
    origin: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    qty: Schema.Attribute.String & Schema.Attribute.Required;
    slNo: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiNewsPostNewsPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Announcements and updates; same SEO fields as blog articles.';
...
export interface ApiPrivacyPagePrivacyPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Privacy policy page content blocks and SEO';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'privacy.section', true>;
    seo: Schema.Attribute.Component<'seo.entry', false>;
...
export interface ApiReportPageReportPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Report portal config and fallback sample values';
    displayName: 'Report Page';
    pluralName: 'report-pages';
    singularName: 'report-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    samplePatientName: Schema.Attribute.String;
    sampleReportDate: Schema.Attribute.String;
...
export interface ApiScreeningProcessPageScreeningProcessPage
  extends Struct.SingleTypeSchema {
  collectionName: 'screening_process_page';
  info: {
    description: 'Screening process page content and timeline';
    displayName: 'Screening Process Page';
    pluralName: 'screening-process-pages';
    singularName: 'screening-process-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    checklistDescription: Schema.Attribute.Text;
    ...
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'seo.entry', false>;
    steps: Schema.Attribute.Component<'screening.process-step', true>;
    totalTimeLabel: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiServicePackageServicePackage
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    pricing: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Medical services for listing and detail pages';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    inverseRelatedServices: Schema.Attribute.Relation<
      'manyToMany',
      'api::service.service'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    seo: Schema.Attribute.Component<'seo.entry', false>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    tests: Schema.Attribute.Component<'service.simple-line', true>;
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Services page config: categories and comparison rows';
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings: branding, contact, social';
  ...
  attributes: {
    ...
    homeTrustIntroEyebrow: Schema.Attribute.String;
    homeTrustIntroHeading: Schema.Attribute.String;
    homeTrustStatsEyebrow: Schema.Attribute.String;
    homeTrustStatsHeading: Schema.Attribute.String;
